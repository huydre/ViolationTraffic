                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="d-flex align-items-center">
                                    <button class="btn btn-primary" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal">Thêm phương tiện</button>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-content">
                                        <form class="form-insert">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    <label for="vehicle_type" class="form-label">Loại phương
                                                        tiện</label>
                                                ...
                                                <div class="mb-3">
                                                    <label for="registration_date" class="form-label">Ngày đăng
                                                        ký</label>
